  ...
  return (
    <div className="map-container">
      ...
      <div className="node stop-1-node">
        <img src={startImg} alt="Stop 1" className="stop" onError={(e) => e.target.src = placeholderImg} />
        <div className="label">Groceries</div>
      </div>

      {/* Stop 2 */}
      <div className="node stop-2-node">
        <img src={startImg} alt="Stop 2" className="stop" onError={(e) => e.target.src = placeholderImg} />
        <div className="label">Furniture</div>
      </div>

      {/* Stop 3 */}
      <div className="node stop-3-node">
        <img src={startImg} alt="Stop 3" className="stop" onError={(e) => e.target.src = placeholderImg} />
        <div className="label">Apparel</div>
      </div>

      {/* End node */}
      <div className="node end-node">
        <img src={startImg} alt="End" className="end" onError={(e) => e.target.src = placeholderImg} />
